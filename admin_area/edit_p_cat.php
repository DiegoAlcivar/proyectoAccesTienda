        ...
        <div class="col-lg-12"><!-- col-lg-12 Starts -->
            ...
            <ol class="breadcrumb"><!-- breadcrumb Starts -->
                ...
                <li>
                    ...
                    <i class="fa fa-dashboard"></i> Dashboard / Editar categoria del producto
            ...
            <div class="panel panel-default"><!-- panel panel-default Starts -->
                ...
                <div class="panel-heading"><!-- panel-heading Starts -->
                    ...
                    <h3 class="panel-title"><!-- panel-title Starts -->
                        ...
                        <i class="fa fa-money fa-fw"></i> Editar categoria del producto
                ...
                <div class="panel-body"><!-- panel-body Starts -->
                    ...
                    <form class="form-horizontal" action="" method="post" enctype="multipart/form-data"><!-- form-horizontal Starts -->
                        ...
                        <div class="form-group"><!-- form-group Starts -->
                            ...
                            <label class="col-md-3 control-label">Titulo de la categoria del producto</label>
                        ...
                        <div class="form-group"><!-- form-group Starts -->
                            ...
                            <label class="col-md-3 control-label">Mostrar como categoria del producto principal</label>
                        ...
                        <div class="form-group"><!-- form-group Starts -->
                            ...
                            <label class="col-md-3 control-label"> Seleccionar una imagen de categoria del producto</label>
